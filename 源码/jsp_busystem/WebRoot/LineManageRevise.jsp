...
ArrayList  al= lbc.getLineinfoByLineID(LineId);
LineBean lb = (LineBean)al.get(0);
...
<form action="LineInfoServlet?flag=Revise&LineId=<%=lb.getLineID()%>&pageNow=<%=pageNow %>" method="post">
  <table width="450" height="100%" border="0">
    <tr>
      <td width="150" align="right"><span class="STYLE2">公交编号</span></td>
      <td width="300"><input type="text" name="Bus_Id" value="<%=lb.getBus_ID()%>"></td>
    </tr>
    <tr>
      <td align="right"><span class="STYLE2">站点ID</span></td>
      <td><input type="text" name="Sta_Id" value="<%=lb.getSta_ID()%>"></td>
    </tr>
    <tr>
      <td align="right"><span class="STYLE2">路程</span></td>
      <td><input type="text" name="Distance" value="<%=lb.getDistance()%>"></td>
    </tr>
    <tr>
